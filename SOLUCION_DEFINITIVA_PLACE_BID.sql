-- ============================================
-- SOLUCIÓN DEFINITIVA: Eliminar TODAS y crear solo la correcta
-- ============================================

-- PASO 1: Eliminar TODAS las versiones posibles (incluyendo NUMERIC)
...
-- ============================================
-- PASO 3: CREAR SOLO LA VERSIÓN CORRECTA
-- ============================================
...
-- Verificar que solo hay UNA versión y que tiene la nueva lógica
SELECT 
...
-- Debe retornar UNA SOLA fila con ambos checks en verde ✅
