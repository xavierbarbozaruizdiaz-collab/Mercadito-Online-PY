-- Duración por defecto de subastas: 2 minutos (antes 24 horas / 1440)
...
COMMENT ON FUNCTION public.activate_scheduled_auctions IS
  'Activa subastas programadas. Duración por defecto: 2 minutos si no hay duration_minutes en attributes.';
